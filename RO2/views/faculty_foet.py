...
class RO2FacultyFOETViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/foet/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/review.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r2/faculty/foet/print.html", context)
    ...
    def submit(request, pk):
        ...
        context['can_submit'] = file.ro2_validator.is_valid_for_ro(
            file.user.designation_abbreviation == 'assistant_prof_on_contract')
        return render(request, "html/r2/faculty/foet/submit.html", context)
