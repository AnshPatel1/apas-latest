...
class RO2FacultyFOLSViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r2/faculty/fols/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/academia-collab-entry.html", context)
    ...
    def international_admission_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/international-admission-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/fols/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/review.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r2/faculty/fols/print.html", context)
    ...
    def submit(request, pk):
        ...
        context['can_submit'] = file.ro2_validator.is_valid_for_ro(
            file.user.designation_abbreviation == 'assistant_prof_on_contract')
        return render(request, "html/r2/faculty/fols/submit.html", context)
