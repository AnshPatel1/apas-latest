...
class RO2FacultyMathViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r2/faculty/maths/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro2_validator.save()
        return render(request, "html/r2/faculty/maths/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/review.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r2/faculty/maths/print.html", context)
    ...
    def submit(request, pk):
        ...
        context['can_submit'] = file.ro2_validator.is_valid_for_ro(
            file.user.designation_abbreviation == 'assistant_prof_on_contract')
        return render(request, "html/r2/faculty/maths/submit.html", context)
