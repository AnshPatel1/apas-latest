...
class UploadCSV(models.Model):
    ...
    upload_choices = (
        ...
        ('project', 'Project'),
        ('scopus_wos', 'Paper Publications in Scopus & Web of Science'),
...
class ViewAcademiaCollaboration(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_academia_collab_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_academia_collab_bulk_csv', null=True, blank=True)
...
class ViewCoCurricular(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_co_curricular_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_co_curricular_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    marks = models.FloatField()
...
class ViewConsultancy(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_consultancy_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_consultancy_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewPhDGuidance(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_phd_guidance_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_phd_guidance_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewProject(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_project_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_project_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewExamDuty(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_exam_duty_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_exam_duty_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewStudentFeedback(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_student_feedback_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_student_feedback_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewTeachingLoad(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_teaching_load_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_teaching_load_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAward(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_award_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_award_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAdditionalMarks(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_additional_marks_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='math_additional_marks_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ErrorLog(models.Model):
    ...
    created_by = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='math_error_log_user', editable=False)
