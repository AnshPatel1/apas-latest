...
class UploadCSV(models.Model):
    ...
    upload_choices = (
        ...
        ('project', 'Project'),
        ('scopus_wos', 'Paper Publications in Scopus and Web of Science'),
    ...
    def clean(self):
        ...
        elif self.upload_type == 'scopus_wos':
            with open(self.file.path, 'r') as f:
                csvreader = list(csv.reader(f))
                if len(csvreader[0]) != 14:
                    raise UploadError("Not correct file format", self.file.url, self.upload_type)
                objects = []
                for row in csvreader[1:]:
                    try:
            ...
            with open(self.file.path, 'r') as f:
                ...
                for row in csvreader[1:]:
                    ...
                    try:
                        ...
                        bk.title = row[4]
                        if row[5] == 'research' or row[5] == 'text':
                            bk.category = row[5]
                        else:
...
class ViewAcademiaCollaboration(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='academia_collab_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='academia_collab_bulk_csv', null=True, blank=True)
...
class ViewCoCurricular(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='co_curricular_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='co_curricular_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    marks = models.FloatField()
...
class ViewConsultancy(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='consultancy_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='consultancy_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewPatent(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='patent_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='patent_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    description = models.TextField()
...
class ViewPhDGuidance(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='phd_guidance_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='phd_guidance_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    status = models.CharField(max_length=100)
...
class ViewProject(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='project_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='project_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewScopusWos(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='scopus_wos_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='scopus_wos_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    ...
    conference_organization = models.CharField(max_length=1000)
...
class ViewBook(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='book_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='book_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewExamDuty(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='exam_duty_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='exam_duty_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewStudentFeedback(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='student_feedback_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='student_feedback_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewTeachingLoad(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='teaching_load_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='teaching_load_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAward(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='award_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='award_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAdditionalMarks(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='additional_marks_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='additional_marks_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ErrorLog(models.Model):
    ...
    created_by = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='error_log_user', editable=False)
