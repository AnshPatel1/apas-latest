...
class UploadCSV(models.Model):
    ...
    upload_choices = (
        ...
        ('project', 'Project'),
        ('scopus_wos_ugc_abdc', 'Paper Publications in Scopus, Web of Science, UGC Care and ABDC'),
    ...
    def clean(self):
        ...
        elif self.upload_type == 'scopus_wos_ugc_abdc':
            with open(self.file.path, 'r') as f:
                csvreader = list(csv.reader(f))
            ...
            with open(self.file.path, 'r') as f:
                ...
                for row in csvreader[1:]:
                    ...
                    try:
                        ...
                        ad.pgp_chair = float(row[3])
                        ad.e_mba_chair = float(row[4])
                    except ValueError:
                        raise UploadError("Make sure the data is correct at row " + str(csvreader.index(row) + 1), self.file.url, self.upload_type)
                    objects.append(ad)
...
class ViewAcademiaCollaboration(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_academia_collab_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_academia_collab_bulk_csv', null=True, blank=True)
...
class ViewCoCurricular(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_co_curricular_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_co_curricular_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    marks = models.FloatField()
...
class ViewConsultancy(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_consultancy_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_consultancy_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewPatent(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_patent_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_patent_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    description = models.TextField()
...
class ViewPhDGuidance(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_phd_guidance_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_phd_guidance_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    status = models.CharField(max_length=100)
...
class ViewProject(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_project_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_project_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewScopusWos(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_scopus_wos_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_scopus_wos_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewBook(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_book_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_book_bulk_csv', null=True, blank=True)
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewExamDuty(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_exam_duty_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_exam_duty_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewStudentFeedback(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_student_feedback_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_student_feedback_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewTeachingLoad(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_teaching_load_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_teaching_load_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAward(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_award_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_award_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAdditionalMarks(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_additional_marks_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='foem_additional_marks_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ErrorLog(models.Model):
    ...
    created_by = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='foem_error_log_user', editable=False)
