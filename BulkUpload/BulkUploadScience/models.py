...
class ViewCoCurricular(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_co_curricular_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_co_curricular_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    marks = models.FloatField()
...
class ViewPhDGuidance(models.Model):
    ...
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_phd_guidance_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_phd_guidance_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
    status = models.CharField(max_length=100)
...
class ViewProject(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_project_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_project_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewExamDuty(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_exam_duty_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_exam_duty_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewStudentFeedback(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_student_feedback_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_student_feedback_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewTeachingLoad(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_teaching_load_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_teaching_load_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAward(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_award_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_award_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ViewAdditionalMarks(models.Model):
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_additional_marks_bulk_faculty')
    csv_origin = models.ForeignKey(UploadCSV, on_delete=models.CASCADE, related_name='science_additional_marks_bulk_csv')
    designation = models.CharField(max_length=100)
    department = models.CharField(max_length=100)
...
class ErrorLog(models.Model):
    ...
    created_by = models.ForeignKey('Account.User', on_delete=models.CASCADE, related_name='science_error_log_user', editable=False)
