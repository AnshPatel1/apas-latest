...
urlpatterns = [
    ...
    path('api/books/finalize/view/', APIVerifyViews.finalize_verified_books_view, name='hr-api-books-finalize'),
    path('api/paper/finalize/', APIVerifyViews.finalize_verified_paper, name='hr-api-paper-finalize'),
    path('api/paper/finalize/view/', APIVerifyViews.finalize_verified_paper_view, name='hr-api-paper-finalize'),
