...
class RO1FacultyFOEMViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r1/faculty/foem/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.arranging_conferences_available:
            ...
            file.ro1_validator.arranging_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST' and file.being_mentor_available:
            ...
            file.ro1_validator.mentorship_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.attending_conferences_available:
            ...
            file.ro1_validator.attending_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST' and file.community_development_available:
            ...
            file.ro1_validator.community_development_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foem/senior-feedback.html", context)
    ...
    def submit(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/submit.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r1/faculty/foem/print.html", context)
