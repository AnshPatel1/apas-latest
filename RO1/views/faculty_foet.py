...
class RO1FacultyFOETViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r1/faculty/foet/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.arranging_conferences_available:
            ...
            file.ro1_validator.arranging_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST' and file.being_mentor_available:
            ...
            file.ro1_validator.mentorship_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.attending_conferences_available:
            ...
            file.ro1_validator.attending_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST' and file.community_development_available:
            ...
            file.ro1_validator.community_development_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/foet/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        context['academic_practices'] = file.modern_teaching_methods.marks.ro1 + file.upkeep_of_course_files_marks.ro1 + file.inclusion_of_alumni_marks.ro1

        return render(request, "html/r1/faculty/foet/review.html", context)
    ...
    def submit(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/submit.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r1/faculty/foet/print.html", context)
    ...
    def get_file(appraisee_id):
        try:
            ...
            if appraisee.designation_abbreviation == "assistant_prof_on_contract":
                ...
                return None
        except FOETAssistantProfOnContractAppraisalFile.DoesNotExist or FOETAssistantProfAppraisalFile.DoesNotExist or FOETAssociateProfAppraisalFile.DoesNotExist or FOETProfAppraisalFile.DoesNotExist or User.DoesNotExist:
