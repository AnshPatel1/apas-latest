...
class RO1FacultyMathViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r1/faculty/maths/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.arranging_conferences_available:
            ...
            file.ro1_validator.arranging_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST' and file.being_mentor_available:
            ...
            file.ro1_validator.mentorship_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.attending_conferences_available:
            ...
            file.ro1_validator.attending_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST' and file.community_development_available:
            ...
            file.ro1_validator.community_development_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/maths/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/review.html", context)
    ...
    def submit(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/submit.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r1/faculty/maths/print.html", context)
...
class FacultyHelperFunctions:
    ...
    def calculateResult(username):
        ...
        if appraisee.designation_abbreviation == "assistant_prof_on_contract":
            file = MathAssistantProfOnContractAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "assistant_prof":
            file = MathAssistantProfAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "associate_prof":
            file = MathAssociateProfAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "prof":
            file = MathProfAppraisalFile.objects.filter(user=appraisee).first()
    ...
    def get_file(appraisee_id):
        try:
            ...
            if appraisee.designation_abbreviation == "assistant_prof_on_contract":
                ...
                return None
        except MathAssistantProfOnContractAppraisalFile.DoesNotExist or MathAssistantProfAppraisalFile.DoesNotExist or MathAssociateProfAppraisalFile.DoesNotExist or MathProfAppraisalFile.DoesNotExist or User.DoesNotExist:
