...
class RO1FacultyRedirectViewSet:
    @staticmethod
    ...
    def redirect(request, pk):
        ...
        if category is None:
            ...
            return HttpResponseRedirect(reverse('ro1-faculty-foet-faculty-home', kwargs={'pk': pk}))
        elif category == "SLS":
            return HttpResponseRedirect(reverse('ro1-faculty-fols-faculty-home', kwargs={'pk': pk}))
        elif category == "SPM":
            return HttpResponseRedirect(reverse('ro1-faculty-foem-faculty-home', kwargs={'pk': pk}))
        elif category == "MATH":
            return HttpResponseRedirect(reverse('ro1-faculty-maths-faculty-home', kwargs={'pk': pk}))
        elif category == "SCIENCE":
            return HttpResponseRedirect(reverse('ro1-faculty-science-faculty-home', kwargs={'pk': pk}))
        else:
            return HttpResponseRedirect("Please contact admin. This user is not included in any cycle inclusion.")
