...
class RO1FacultyFOLSViewSet:
    ...
    def dashboard(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/dashboard.html", context)
    ...
    def verify_data(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'verify-data', 'file': FacultyHelperFunctions.get_file(pk),
                   'cycle': FacultyHelperFunctions.get_cycle()}
        return render(request, "html/r1/faculty/fols/verify-data.html", context)
    ...
    def teaching_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/teaching.html", context)
    ...
    def research_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/research-entry.html", context)
    ...
    def project_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/project-entry.html", context)
    ...
    def phd_guidance_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/dissertation-entry.html", context)
    ...
    def patent_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/patent-entry.html", context)
    ...
    def award_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/award-entry.html", context)
    ...
    def consultancy_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/academia-collab-entry.html", context)
    ...
    def international_admission_entry(request, pk):
        ...
        context = {'user': request.user, 'page_name': 'international-admission-entry', 'file': file,
                   'cycle': FacultyHelperFunctions.get_cycle()}
        if request.method == 'POST':
            file.ro1_validator.international_admission_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/international-admission-entry.html", context)
    ...
    def arranging_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.arranging_conferences_available:
            ...
            file.ro1_validator.arranging_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/arranging-conference.html", context)
    ...
    def mentorship_entry(request, pk):
        ...
        if request.method == 'POST' and file.being_mentor_available:
            ...
            file.ro1_validator.mentorship_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request, pk):
        ...
        if request.method == 'POST' and file.attending_conferences_available:
            ...
            file.ro1_validator.attending_conferences_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request, pk):
        ...
        if request.method == 'POST' and file.community_development_available:
            ...
            file.ro1_validator.community_development_validated = True
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/extra-curricular-entry.html", context)
    ...
    def additional_entry(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/additional-entry.html", context)
    ...
    def senior_feedback(request, pk):
        ...
        if request.method == 'POST':
            ...
            file.ro1_validator.save()
        return render(request, "html/r1/faculty/fols/senior-feedback.html", context)
    ...
    def review(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/review.html", context)
    ...
    def submit(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/submit.html", context)
    ...
    def print(request, pk):
        ...
        return render(request, "html/r1/faculty/fols/print.html", context)
...
class FacultyHelperFunctions:
    ...
    def calculateResult(username):
        ...
        if appraisee.designation_abbreviation == "assistant_prof_on_contract":
            file = FOLSAssistantProfOnContractAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "assistant_prof":
            file = FOLSAssistantProfAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "associate_prof":
            file = FOLSAssociateProfAppraisalFile.objects.filter(user=appraisee).first()
        elif appraisee.designation_abbreviation == "prof":
            file = FOLSProfAppraisalFile.objects.filter(user=appraisee).first()
    ...
    def get_file(appraisee_id):
        try:
            ...
            if appraisee.designation_abbreviation == "assistant_prof_on_contract":
                ...
                return None
        except FOLSAssistantProfOnContractAppraisalFile.DoesNotExist or FOLSAssistantProfAppraisalFile.DoesNotExist or FOLSAssociateProfAppraisalFile.DoesNotExist or FOLSProfAppraisalFile.DoesNotExist or User.DoesNotExist:
