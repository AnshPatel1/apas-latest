...
class FOETGoalSheetModelAdmin(admin.ModelAdmin):
...
class AppraisalFileModelAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ['research_books', 'textbooks', 'publications_in_scopus_wos', 'conference_proceedings_scopus_wos', 'e_publications_articles', 'projects', 'phd_guidance',
                         'bachelors_dissertation', 'masters_thesis', 'patents', 'recognition_awards', 'providing_consultancy', 'industry_collaboration',
                         'arranging_conferences', 'being_mentor', 'attending_conferences', 'community_development', 'self_development_trainings']


admin.site.register(FOETGoalSheetAssistantProfOnContract, FOETGoalSheetModelAdmin)
admin.site.register(FOETGoalSheetAssistantProf, FOETGoalSheetModelAdmin)
admin.site.register(FOETGoalSheetAssociateProf, FOETGoalSheetModelAdmin)
admin.site.register(FOETGoalSheetProf, FOETGoalSheetModelAdmin)
...
admin.site.register(FOETAssistantProfOnContractAppraisalFile, AppraisalFileModelAdmin)
admin.site.register(FOETAssistantProfAppraisalFile, AppraisalFileModelAdmin)
admin.site.register(FOETAssociateProfAppraisalFile, AppraisalFileModelAdmin)
admin.site.register(FOETProfAppraisalFile, AppraisalFileModelAdmin)
