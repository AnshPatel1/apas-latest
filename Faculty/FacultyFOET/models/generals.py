...
class Project(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True)
    innovator = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True)
...
class PhDGuidance(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True)
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True)
...
class Award(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True)
    awardee = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True)
...
class AcademiaCollaboration(models.Model):
    year = models.IntegerField(default=datetime.now().year)
    description = models.TextField(blank=True, null=True)
    mou_marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True)
    contribution_marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name="contrib_marks")
    appraisee = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True)
