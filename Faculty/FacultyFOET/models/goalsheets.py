...
class FOETGoalSheetAssistantProfOnContract(models.Model):
    """This is the FOET Goalsheet model. It contains the fields for the FOET Goalsheet form."""
    # Configurations
    ...
    students_feedback_minimum_marks = models.FloatField(default=8)
    ...
    #  Section 1.E(ii): Textbooks published by International /National Publishers with an established peer review system with ISBN/ISSNs
    #      15 marks to be given per international book per author
    #      10 marks to be given per national book per author
    #      5 marks to be given per chapter in an edited book
    ...
    # Section 2.A.a(ii): Conference Proceedings (only Scopus/WoS indexed) as full papers (Abstracts not to be included)
    #     25 marks to be given for scopus indexed journals in Q1
    #     20 marks to be given for scopus indexed journals in Q2
    #     15 marks to be given for scopus indexed journals in Q3
    #     10 marks to be given for scopus indexed journals in Q4
    ...
    #       Category A:  (fund of Rs. 1 crore and above)
    #           50 marks to be given if appraisee is the PI
    #           40 marks to be given if appraisee is the Co-PI
    ...
    #       Category B:  (above 70 lakhs)
    #           40 marks to be given if appraisee is the PI
    #           30 marks to be given if appraisee is the Co-PI
    ...
    #       Category C:  (above 50 lakhs)
    #           30 marks to be given if appraisee is the PI
    #           20 marks to be given if appraisee is the Co-PI
    ...
    #       Category D:  (above 30 lakhs)
    #           20 marks to be given if appraisee is the PI
    #           15 marks to be given if appraisee is the Co-PI
    ...
    #       Category E:  (above 15 lakhs)
    #           15 marks to be given if appraisee is the PI
    #           10 marks to be given if appraisee is the Co-PI
    ...
    #       Category G:  (above 3 lakhs)
    #           8 marks to be given if appraisee is the PI
    #           4 marks to be given if appraisee is the Co-PI
    ...
    #       Category H:  (above 50K to 3 lakhs)
    #           5 marks to be given if appraisee is the PI
    ...
    # -------------- Section 2.E: Recognition/Awards received --------------
    ...
    # -------------- Section 2.F: Providing Consultancy/ Organizing MDPs , EDPs as Chief Coordinator/ Program Head services on the behalf of University --------------
    ...
    # ------- Section 3.A: Arranging Conferences/ Seminars/Conclaves -------
    #     Max 15 marks to be given by RO/RV
    section_3a_arranging_conferences_max_marks = models.IntegerField(default=15)

    # ------- Section 3.B: Being Mentor to students(providing Career/Academic counselling) -------
    ...
    def __str__(self):
        if self.is_active:
            return f"FoET Asst. Prof. On Contract Goalsheet for {self.year} (Active)"
        else:
            return f"FoET Asst. Prof. On Contract Goalsheet for {self.year}"
...
class FOETGoalSheetAssistantProf(models.Model):
    """This is the FOET Goalsheet model. It contains the fields for the FOET Goalsheet form."""
    # Configurations
    year = models.IntegerField()
    is_active = models.BooleanField(default=False)
    ...
    def __str__(self):
        if self.is_active:
            return f"FoET Asst. Prof. Goalsheet for {self.year} (Active)"
        else:
            return f"FoET Asst. Prof. Goalsheet for {self.year}"
...
class FOETGoalSheetAssociateProf(models.Model):
    """This is the FOET Goalsheet model. It contains the fields for the FOET Goalsheet form."""
    # Configurations
    year = models.IntegerField()
    is_active = models.BooleanField(default=False)
    ...
    def __str__(self):
        if self.is_active:
            return f"FoET Associate Professor Goalsheet for {self.year} (Active)"
        else:
            return f"FoET Associate Professor Goalsheet for {self.year}"
...
class FOETGoalSheetProf(models.Model):
    """This is the FOET Goalsheet model. It contains the fields for the FOET Goalsheet form."""
    # Configurations
    year = models.IntegerField()
    is_active = models.BooleanField(default=False)
    ...
    def __str__(self):
        if self.is_active:
            return f"FoET Professor Goalsheet for {self.year} (Active)"
        else:
            return f"FOET Professor Goalsheet for {self.year}"
