...
from APAS.utils import render_to_pdf
from BulkUpload.BulkUploadFoET.models import *
from MasterConfiguration.models import FOETFacultyAppraisalCycleConfiguration, SOTFacultyAppraisalCycleInclusion, \
    CurrentDate, ShowResult
...
class FacultyViewSet:
    ...
    def dashboard(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/dashboard.html", context)
    ...
    def verify_data(request):
        ...
        if request.method == 'POST' and not file.has_verified_data:
            ...
            if file.has_verified_data and request.method == 'POST':
                return render(request, "html/faculty/foet/verify-data.html", context)
    ...
    def teaching_entry(request):
        ...
        return render(request, "html/faculty/foet/teaching.html", context)
    ...
    def research_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/research-entry.html", context)
    ...
    def project_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/project-entry.html", context)
    ...
    def phd_guidance_entry(request):
        ...
        return render(request, "html/faculty/foet/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request):
        ...
        if request.method == 'POST':
            ...
            if masters_available:
                ...
                file.masters_thesis.all().delete()
        return render(request, "html/faculty/foet/dissertation-entry.html", context)
    ...
    def patent_entry(request):
        ...
        return render(request, "html/faculty/foet/patent-entry.html", context)
    ...
    def award_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/award-entry.html", context)
    ...
    def consultancy_entry(request):
        ...
        if request.method == 'POST':
            ...
            file.validator.save()
        if request.user.designation_abbreviation == 'assistant_prof_on_contract' and len(
                file.providing_consultancy.all()) == 0:
            # if True:
            if request.method == 'POST':
                ...
                if available:
                    entries = {key: value for key, value in dict(request.POST).items() if
                               key.startswith('industry-collaboration')}
                    entries = list(entries.values())
                    print(entries)
                    collabs = []
                    for entry in entries:
        ...
        return render(request, "html/faculty/foet/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                entries = {key: value for key, value in dict(request.POST).items() if
                           key.startswith('arranging-conferences')}
                entries = list(entries.values())
                data = []
                for entry in entries:
        ...
        return render(request, "html/faculty/foet/arranging-conference.html", context)
    ...
    def mentorship_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                ...
                file.being_mentor.all().delete()
        return render(request, "html/faculty/foet/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                ...
                file.attending_conferences.all().delete()
        return render(request, "html/faculty/foet/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                entries = {key: value for key, value in dict(request.POST).items() if
                           key.startswith('community-development')}
                entries = list(entries.values())
                data = []
                for entry in entries:
                    point = GenericMarkedParameter()
                ...
                file.community_development.all().delete()
        return render(request, "html/faculty/foet/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/extra-curricular-entry.html", context)
    ...
    def additional_entry(request):
        ...
        return render(request, "html/faculty/foet/additional-entry.html", context)
    ...
    def review(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/foet/review.html", context)
    ...
    def submit(request):
        ...
        file = FacultyHelperFunctions.get_appraisal_file(request)
        context['cycle'] = FacultyHelperFunctions.get_cycle()
        context['can_submit'] = file.validator.is_valid(
            request.user.designation_abbreviation == 'assistant_prof_on_contract')
        if file is not None:
            context['file'] = file
        if request.method == 'POST':
            file.file_level = 'RO1'
            file.save()
        return render(request, "html/faculty/foet/submit.html", context)
    ...
    def summary(request):
        ...
        context['external_guidance'] = file.phd_guidance.filter(category='external')
        context['internal_guidance'] = file.phd_guidance.filter(category='internal')
        return render(request, "html/faculty/foet/download.html", context)
    ...
    def result(request):
        ...
        return render(request, "html/faculty/foet/result.html", context)
...
class FacultyHelperFunctions:
    ...
    def check_authorized_user(request):
        ...
        if request.user.is_authenticated and request.user.is_active and request.user.roles == 'fac' and SOTFacultyAppraisalCycleInclusion.check_inclusion(
                request.user):
            return True
        else:
            return False
    ...
    @staticmethod
    def get_appraisal_file(
            request) -> FOETAssistantProfOnContractAppraisalFile | FOETAssistantProfAppraisalFile | FOETAssociateProfAppraisalFile | FOETProfAppraisalFile:
        try:
            file = None
            if request.user.designation_abbreviation == 'assistant_prof_on_contract':
                try:
                    file = FOETAssistantProfOnContractAppraisalFile.objects.get(user=request.user)
                except FOETAssistantProfOnContractAppraisalFile.DoesNotExist:
                    file = FOETAssistantProfOnContractAppraisalFile()
                    file.user = request.user
                    file.configuration = FOETGoalSheetAssistantProfOnContract.objects.filter(is_active=True).first()
                    file.save()
            elif request.user.designation_abbreviation == 'assistant_prof':
                try:
                    file = FOETAssistantProfAppraisalFile.objects.get(user=request.user)
                except FOETAssistantProfAppraisalFile.DoesNotExist:
                    file = FOETAssistantProfAppraisalFile()
                    file.user = request.user
                    file.configuration = FOETGoalSheetAssistantProf.objects.filter(is_active=True).first()
                    file.save()
                ...
                try:
                    file = FOETProfAppraisalFile.objects.get(user=request.user)
                except FOETProfAppraisalFile.DoesNotExist:
                    file = FOETProfAppraisalFile()
                    file.user = request.user
                    file.configuration = FOETGoalSheetProf.objects.filter(is_active=True).first()
                    file.save()
            return file
    ...
    def get_cycle():
        ...
        except FOETFacultyAppraisalCycleConfiguration.DoesNotExist:
