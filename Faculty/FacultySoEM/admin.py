...
class FOEMGoalSheetModelAdmin(admin.ModelAdmin):
...
class AppraisalFileModelAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ['research_books', 'textbooks', 'publications_in_scopus_wos', 'conference_proceedings_scopus_wos', 'e_publications_articles', 'projects', 'phd_guidance',
                         'masters_thesis', 'recognition_awards', 'providing_consultancy', 'industry_collaboration',
                         'arranging_conferences', 'being_mentor', 'attending_conferences', 'community_development', 'self_development_trainings']


admin.site.register(FOEMGoalSheetAssistantProfOnContract)  # , FOEMGoalSheetModelAdmin)
admin.site.register(FOEMGoalSheetAssistantProf)  # , FOEMGoalSheetModelAdmin)
admin.site.register(FOEMGoalSheetAssociateProf)  # , FOEMGoalSheetModelAdmin)
admin.site.register(FOEMGoalSheetProf)  # , FOEMGoalSheetModelAdmin)
...
admin.site.register(FOEMAssistantProfOnContractAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOEMAssistantProfAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOEMAssociateProfAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOEMProfAppraisalFile)  # , AppraisalFileModelAdmin)
