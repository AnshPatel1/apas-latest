...
class FOEMGoalSheetProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"FoEM Professor On Contract Goalsheet for {self.year} (Active)"
        else:
            return f"FoEM Professor On Contract Goalsheet for {self.year}"

    class Meta:
        verbose_name = "Goalsheet Configuration for FoEM Professor"
        verbose_name_plural = "Goalsheet Configurations for FoEM Professor"
