...
class MathGoalSheetAssistantProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"Maths Asst. Prof. Goalsheet for {self.year} (Active)"
        else:
            return f"Maths Asst. Prof. Goalsheet for {self.year}"
