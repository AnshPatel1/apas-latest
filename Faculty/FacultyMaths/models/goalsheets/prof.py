...
class MathGoalSheetProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"Maths Prof. Goalsheet for {self.year} (Active)"
        else:
            return f"Maths Prof. Goalsheet for {self.year}"
