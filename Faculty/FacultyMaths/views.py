...
from BulkUpload.BulkUploadMaths.models import *
from MasterConfiguration.models import MathFacultyAppraisalCycleConfiguration, MathFacultyAppraisalCycleInclusion, CurrentDate, ShowResult
from .models import *
...
class FacultyViewSet:
    ...
    def dashboard(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/maths/dashboard.html", context)
    ...
    def verify_data(request):
        ...
        if request.method == 'POST' and not file.has_verified_data:
            ...
            if file.has_verified_data and request.method == 'POST':
                return render(request, "html/faculty/maths/verify-data.html", context)
    ...
    def teaching_entry(request):
        ...
        return render(request, "html/faculty/maths/teaching.html", context)
    ...
    def phd_guidance_entry(request):
        ...
        return render(request, "html/faculty/maths/phd-guidance-entry.html", context)
    ...
    def dissertation_entry(request):
        ...
        if request.method == 'POST':
            ...
            if masters_available:
                ...
                file.masters_thesis.all().delete()
        return render(request, "html/faculty/maths/dissertation-entry.html", context)
    ...
    def award_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/maths/award-entry.html", context)
    ...
    #                 file.industry_collaboration.all().delete()
    #
    #     return render(request, "html/faculty/maths/consultancy-entry.html", context)
    ...
    def academia_collab_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/maths/academia-collab-entry.html", context)
    ...
    def arranging_conference_entry(request):
        ...
        return render(request, "html/faculty/maths/arranging-conference.html", context)
    ...
    def mentorship_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                ...
                file.being_mentor.all().delete()
        return render(request, "html/faculty/maths/mentorship-entry.html", context)
    ...
    def attending_conference_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                ...
                file.attending_conferences.all().delete()
        return render(request, "html/faculty/maths/attending-conferences-entry.html", context)
    ...
    def community_development_entry(request):
        ...
        if request.method == 'POST':
            ...
            if available:
                ...
                file.community_development.all().delete()
        return render(request, "html/faculty/maths/community-development-entry.html", context)
    ...
    def extra_curricular_entry(request):
        ...
        if file is not None:
            context['file'] = file
        return render(request, "html/faculty/maths/extra-curricular-entry.html", context)
    ...
    def additional_entry(request):
        ...
        return render(request, "html/faculty/maths/additional-entry.html", context)
    ...
    def submit(request):
        ...
        if request.method == 'POST':
            file.file_level = 'RO1'
            file.save()
        return render(request, "html/faculty/maths/submit.html", context)
    ...
    def summary(request):
        ...
        context['external_guidance'] = file.phd_guidance.filter(category='external')
        context['internal_guidance'] = file.phd_guidance.filter(category='internal')
        return render(request, "html/faculty/maths/download.html", context)
    ...
    def result(request):
        ...
        return render(request, "html/faculty/maths/result.html", context)

class FacultyHelperFunctions:
    @staticmethod
    def check_authorized_user(request):
        print(request.user.roles)
        if request.user.is_authenticated and request.user.is_active and request.user.roles == 'fac' and MathFacultyAppraisalCycleInclusion.check_inclusion(request.user):
            return True
        else:
            return False

    @staticmethod
    def get_appraisal_file(request) -> MathAssistantProfOnContractAppraisalFile | MathAssistantProfAppraisalFile | MathAssociateProfAppraisalFile | MathProfAppraisalFile:
        try:
            file = None
            if request.user.designation_abbreviation == 'assistant_prof_on_contract':
                try:
                    file = MathAssistantProfOnContractAppraisalFile.objects.get(user=request.user)
                except MathAssistantProfOnContractAppraisalFile.DoesNotExist:
                    file = MathAssistantProfOnContractAppraisalFile()
                    file.user = request.user
                    file.configuration = MathGoalSheetAssistantProfOnContract.objects.filter(is_active=True).first()
                    file.save()
            elif request.user.designation_abbreviation == 'assistant_prof':
                try:
                    file = MathAssistantProfAppraisalFile.objects.get(user=request.user)
                except MathAssistantProfAppraisalFile.DoesNotExist:
                    file = MathAssistantProfAppraisalFile()
                    file.user = request.user
                    file.configuration = MathGoalSheetAssistantProf.objects.filter(is_active=True).first()
                    file.save()
            elif request.user.designation_abbreviation == 'associate_prof':
                try:
                    file = MathAssociateProfAppraisalFile.objects.get(user=request.user)
                except MathAssociateProfAppraisalFile.DoesNotExist:
                    print("hi")
                    file = MathAssociateProfAppraisalFile()
                    file.user = request.user
                    file.configuration = MathGoalSheetAssociateProf.objects.filter(is_active=True).first()
                    file.save()
            elif request.user.designation_abbreviation == 'prof':
                try:
                    file = MathProfAppraisalFile.objects.get(user=request.user)
                except MathProfAppraisalFile.DoesNotExist:
                    file = MathProfAppraisalFile()
                    file.user = request.user
                    file.configuration = MathGoalSheetProf.objects.filter(is_active=True).first()
                    file.save()
            return file
    ...
    def get_cycle():
        ...
        except MathFacultyAppraisalCycleConfiguration.DoesNotExist:
