...
from . import ScienceAssistantProfOnContractAppraisalFile, ScienceAssistantProfAppraisalFile, ScienceAssociateProfAppraisalFile, ScienceProfAppraisalFile
...
class CalculationEngine:
    ...
    def __init__(self, file: ScienceAssistantProfOnContractAppraisalFile | ScienceAssistantProfAppraisalFile | ScienceAssociateProfAppraisalFile | ScienceProfAppraisalFile):
        ...
        for project in self.file.projects.all():
            if project.marks.ro1_agreed:
                if project.project_category == 'INS':
                    ...
                    if project.project_category == 'A':
                        total += self.file.configuration.section_2a_c_category_a_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_a_per_pi
                    elif project.project_category == 'B':
                        total += self.file.configuration.section_2a_c_category_b_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_b_per_pi
                    elif project.project_category == 'C':
                        total += self.file.configuration.section_2a_c_category_c_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_c_per_pi
                    elif project.project_category == 'D':
                        total += self.file.configuration.section_2a_c_category_d_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_d_per_pi
                    elif project.project_category == 'E':
                        total += self.file.configuration.section_2a_c_category_e_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_e_per_pi
                    elif project.project_category == 'F':
                        total += self.file.configuration.section_2a_c_category_f_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_f_per_pi
                    elif project.project_category == 'G':
                        total += self.file.configuration.section_2a_c_category_g_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_g_per_pi
                    elif project.project_category == 'H':
                        total += self.file.configuration.section_2a_c_category_h_per_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_h_per_pi
                elif project.project_participation == 'copi':
                    if project.project_category == 'A':
                        total += self.file.configuration.section_2a_c_category_a_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_a_per_co_pi
                    elif project.project_category == 'B':
                        total += self.file.configuration.section_2a_c_category_b_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_b_per_co_pi
                    elif project.project_category == 'C':
                        total += self.file.configuration.section_2a_c_category_c_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_c_per_co_pi
                    elif project.project_category == 'D':
                        total += self.file.configuration.section_2a_c_category_d_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_d_per_co_pi
                    elif project.project_category == 'E':
                        total += self.file.configuration.section_2a_c_category_e_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_e_per_co_pi
                    elif project.project_category == 'F':
                        total += self.file.configuration.section_2a_c_category_f_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_f_per_co_pi
                    elif project.project_category == 'G':
                        total += self.file.configuration.section_2a_c_category_g_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_g_per_co_pi
                    elif project.project_category == 'H':
                        total += self.file.configuration.section_2a_c_category_h_per_co_pi
                        project.marks.ro1 = self.file.configuration.section_2a_c_category_h_per_co_pi
    ...
    def calculateSectionD(self):
        ...
        if self.file.user.designation_abbreviation == 'assistant_prof_on_contract' and len(list(self.file.patents.all())) == 0:
        ...
        for patent in self.file.patents.all():
            if patent.marks.ro1_agreed:
                if patent.status == 'filed':
                    total += self.file.configuration.section_2c_patent_filed
                    patent.marks.ro1 = self.file.configuration.section_2c_patent_filed
                elif patent.status == 'published':
                    total += self.file.configuration.section_2c_patent_published
                    patent.marks.ro1 = self.file.configuration.section_2c_patent_published
                elif patent.status == 'granted':
                    total += self.file.configuration.section_2c_patent_granted
                    patent.marks.ro1 = self.file.configuration.section_2c_patent_granted
                elif patent.status == 'licensed':
                    total += self.file.configuration.section_2c_patent_granted_and_licensed
                    patent.marks.ro1 = self.file.configuration.section_2c_patent_granted_and_licensed
            patent.marks.save()
        return round(total, 2)
    ...
    # def calculateSectionF(self):
    #     if self.file.user.designation_abbreviation == 'assistant_prof_on_contract' and len(list(self.file.providing_consultancy.all())) == 0:
    ...
    #             total += self.file.configuration.section_2f_industry_collaboration_project
    #             industry_collaboration.marks.ro1 = self.file.configuration.section_2f_industry_collaboration_project
    #         else:
    ...
    def calculateAcademiaCollaboration(self):
        ...
        self.file.academia_collaboration_total.ro1 = round(self.file.academia_collaboration_total.ro1, 2)
        self.file.academia_collaboration_total.save()
        self.file.save()
        return self.file.academia_collaboration_total.ro1
...
class CalculationEngineR2:
        ...
        for project in self.file.projects.all():
            if project.marks.ro2_agreed:
                if project.project_category == 'INS':
                    ...
                    if project.project_category == 'A':
                        total += self.file.configuration.section_2a_c_category_a_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_a_per_pi
                    elif project.project_category == 'B':
                        total += self.file.configuration.section_2a_c_category_b_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_b_per_pi
                    elif project.project_category == 'C':
                        total += self.file.configuration.section_2a_c_category_c_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_c_per_pi
                    elif project.project_category == 'D':
                        total += self.file.configuration.section_2a_c_category_d_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_d_per_pi
                    elif project.project_category == 'E':
                        total += self.file.configuration.section_2a_c_category_e_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_e_per_pi
                    elif project.project_category == 'F':
                        total += self.file.configuration.section_2a_c_category_f_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_f_per_pi
                    elif project.project_category == 'G':
                        total += self.file.configuration.section_2a_c_category_g_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_g_per_pi
                    elif project.project_category == 'H':
                        total += self.file.configuration.section_2a_c_category_h_per_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_h_per_pi
                elif project.project_participation == 'copi':
                    if project.project_category == 'A':
                        total += self.file.configuration.section_2a_c_category_a_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_a_per_co_pi
                    elif project.project_category == 'B':
                        total += self.file.configuration.section_2a_c_category_b_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_b_per_co_pi
                    elif project.project_category == 'C':
                        total += self.file.configuration.section_2a_c_category_c_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_c_per_co_pi
                    elif project.project_category == 'D':
                        total += self.file.configuration.section_2a_c_category_d_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_d_per_co_pi
                    elif project.project_category == 'E':
                        total += self.file.configuration.section_2a_c_category_e_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_e_per_co_pi
                    elif project.project_category == 'F':
                        total += self.file.configuration.section_2a_c_category_f_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_f_per_co_pi
                    elif project.project_category == 'G':
                        total += self.file.configuration.section_2a_c_category_g_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_g_per_co_pi
                    elif project.project_category == 'H':
                        total += self.file.configuration.section_2a_c_category_h_per_co_pi
                        project.marks.ro2 = self.file.configuration.section_2a_c_category_h_per_co_pi
    ...
    def calculatePatent(self):
        ...
        for patent in self.file.patents.all():
            if patent.marks.ro2_agreed:
                if patent.status == 'filed':
                    total += self.file.configuration.section_2c_patent_filed
                    patent.marks.ro2 = self.file.configuration.section_2c_patent_filed
                elif patent.status == 'published':
                    total += self.file.configuration.section_2c_patent_published
                    patent.marks.ro2 = self.file.configuration.section_2c_patent_published
                elif patent.status == 'granted':
                    total += self.file.configuration.section_2c_patent_granted
                    patent.marks.ro2 = self.file.configuration.section_2c_patent_granted
                elif patent.status == 'licensed':
                    total += self.file.configuration.section_2c_patent_granted_and_licensed
                    patent.marks.ro2 = self.file.configuration.section_2c_patent_granted_and_licensed
            patent.marks.save()
        return round(total, 2)
    ...
    #             total += self.file.configuration.section_2f_industry_collaboration_project
    #             industry_collaboration.marks.ro2 = self.file.configuration.section_2f_industry_collaboration_project
    #         else:
