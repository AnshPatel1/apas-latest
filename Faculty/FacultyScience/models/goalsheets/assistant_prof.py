...
class ScienceGoalSheetAssistantProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"Science Asst. Prof. Goalsheet for {self.year} (Active)"
        else:
            return f"Science Asst. Prof. Goalsheet for {self.year}"

    class Meta:
        verbose_name = "Goalsheet Configuration for Science Assistant Professor"
        verbose_name_plural = "Goalsheet Configurations for Science Assistant Professor"
