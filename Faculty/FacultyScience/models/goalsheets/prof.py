...
class ScienceGoalSheetProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"Science Prof. Goalsheet for {self.year} (Active)"
        else:
            return f"Science Prof. Goalsheet for {self.year}"

    class Meta:
        verbose_name = "Goalsheet Configuration for Science Professor On Contract"
        verbose_name_plural = "Goalsheet Configurations for Science Professor On Contract"
