...
from Faculty.FacultySLS.views import *


urlpatterns = [
    path('', FacultyViewSet.dashboard, name='sls_faculty-home'),
    ...
    path('international-admission/', FacultyViewSet.international_admission_entry, name='international-admission-entry'),
