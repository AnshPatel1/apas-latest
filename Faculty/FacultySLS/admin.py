...
class FOLSGoalSheetModelAdmin(admin.ModelAdmin):
...
class AppraisalFileModelAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ['research_books', 'textbooks', 'publications_in_scopus_wos', 'conference_proceedings_scopus_wos', 'e_publications_articles', 'projects', 'phd_guidance',
                         'bachelors_dissertation', 'masters_thesis', 'recognition_awards', 'providing_consultancy', 'industry_collaboration',
                         'arranging_conferences', 'being_mentor', 'attending_conferences', 'community_development', 'self_development_trainings']


admin.site.register(FOLSGoalSheetAssistantProfOnContract)  # , FOLSGoalSheetModelAdmin)
admin.site.register(FOLSGoalSheetAssistantProf)  # , FOLSGoalSheetModelAdmin)
admin.site.register(FOLSGoalSheetAssociateProf)  # , FOLSGoalSheetModelAdmin)
admin.site.register(FOLSGoalSheetProf)  # , FOLSGoalSheetModelAdmin)
...
admin.site.register(FOLSAssistantProfOnContractAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOLSAssistantProfAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOLSAssociateProfAppraisalFile)  # , AppraisalFileModelAdmin)
admin.site.register(FOLSProfAppraisalFile)  # , AppraisalFileModelAdmin)
