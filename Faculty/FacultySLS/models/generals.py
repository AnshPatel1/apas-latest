...
class TeachingLoad(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_teaching_load')
...
class ModernMethods(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_modern_methods')
...
class ExamDuty(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_exam_duty')
...
class Publication(models.Model):
    ...
    author = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_pub_author')
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_publication')
...
class Paper(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_paper')
    author = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_paper_author')
...
class Project(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_project')
    innovator = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_project_innovator')
...
class PhDGuidance(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_phd')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_phd_faculty')
...
class BachelorsDissertation(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_btech')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_btech_faculty')
...
class MastersDissertation(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_mtech')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_mtech_faculty')
...
class Patent(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_patent')
    innovator = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_patent_innovator')
...
class FacultyAdvisor(models.Model):
    ...
    title = models.TextField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_faculty_advisor')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_faculty_advisor_faculty')
...
class Award(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_award')
    awardee = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_award_awardee')
...
class Consultancy(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_consultancy')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_consultancy_faculty')
...
class Collaboration(models.Model):
    ...
    description = models.TextField(blank=True, null=True)
    amount = models.FloatField(default=0)
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_collaboration')
    faculty = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_collaboration_faculty')
...
class AcademiaCollaboration(models.Model):
    year = models.IntegerField(default=datetime.now().year)
    description = models.TextField(blank=True, null=True)
    mou_marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_academia_collaboration_mou')
    ...
    appraisee = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_academia_collaboration_appraisee')
...
class GenericMarkedParameter(models.Model):
    ...
    title = models.TextField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_generic_marked_parameter')
    appraisee = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_generic_marked_parameter_appraisee')
...
class Certification(models.Model):
    ...
    marks = models.ForeignKey(MarkField, on_delete=models.CASCADE, null=True, blank=True, related_name='sls_certification')
    user = models.ForeignKey('Account.User', on_delete=models.CASCADE, null=True, blank=True, related_name='sls_certification_user')
