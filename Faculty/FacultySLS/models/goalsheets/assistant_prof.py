...
class FOLSGoalSheetAssistantProf(models.Model):
    ...
    def __str__(self):
        if self.is_active:
            return f"FoLS Assistant Professor Goalsheet for {self.year} (Active)"
        else:
            return f"FoLS Assistant Professor Goalsheet for {self.year}"

    class Meta:
        verbose_name = "Goalsheet Configuration for FoLS Assistant Professor"
        verbose_name_plural = "Goalsheet Configurations for FoLS Assistant Professor"
